...
public class DemoWord2Vec
{
    ...
    private static final String TRAIN_FILE_NAME ="data/test/text8/text8";
...
//        for (int i = 0; i <300 ; i++) {
//            System.out.println(docVectorModel.query(documents[0]).getElementArray()[i]);
//        }
    ...
    public static void printNearest(String word, WordVectorModel model)
    {
        System.out.printf("\n                                                Word     Cosine\n------------------------------------------------------------------------\n");
